...
| `openapi/` | The HTTP API of the engine (D5, C38) | version 7 (the model registry, record 42); version 4 (grants and detail); version 3 in Wave 4c A4; version 0 was the empty skeleton of Wave 4a §11 |
...
| `suite/` | The vocabulary every part of the suite shares: grants and detail, headers and the actor, purposes and content classes, the deployment capabilities document, app registry entries, station manifests, the trust list and grants vectors (Wave 4c §4.5) | version 3 (the model registry's grants, record 42 R7); version 2 (grants and detail in place of entitlements); version 1 written down in Wave 4c slice A7 |
