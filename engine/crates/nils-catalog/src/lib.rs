...
fn fixed_fields() -> Vec<Field> {
    ...
    vec![
        ...
        f(
            ...
            true,
            "fingerprint",
            "how many distinct slice positions the stack covers, which is not how many images it holds",
        ),
        f(
            "stack",
            "slice_span_mm",
            ...
            true,
            "fingerprint",
            "the distance from the first slice to the last, in millimetres",
        ),
        f(
            "stack",
            "coverage_source",
            ...
            true,
            "fingerprint",
            "which evidence gave the coverage: slice_location, or none where no image carried a position",
        ),
        f(
            "stack",
            "acquisition_matrix",
            ...
            true,
            "fingerprint",
            "the acquisition matrix as read",
        ),
        f(
            "stack",
            "receive_coil_name",
